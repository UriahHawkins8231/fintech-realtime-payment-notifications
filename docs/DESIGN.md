...
> Design notes for **fintech-realtime-payment-notifications** — a runnable typescript example that Typed Node service that risk-gates and publishes audit-friendly payment notifications.
...
- **Feature code** — the actual task: payment risk notifications.
